...
class Config:
    def __init__(self):
        ...
        self.save_path: str = "/opt/ml/dataset/pt_model/model-31.pt" # 최종 모델을 어디에 저장할지
        self.result_path: str = "/opt/ml/dataset/submission/sub-31.csv" # 마지막 csv 파일을 어디에 저장할지
        self.wandb_name: str = "klue/roberta-large/MLM-with-front-typed+full-relabel-data-more-epoch" # wandb 내에서 작업 이름 설정 (중요)
        self.wandb_group: str = "test" # wandb group.
        self.wandb_note: str = "'mlm + front typed + full-relabel-data'" # wandb note
