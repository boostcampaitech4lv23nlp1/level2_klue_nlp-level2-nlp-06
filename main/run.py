...
class Config:
    def __init__(self):
        ...
        self.wandb_name: str = "'add lstm test4'" # wandb 내에서 작업 이름 설정 (중요)
        self.wandb_group: str = "'add rnn test'" # wandb group.
        self.wandb_note: str = "'lstm, num_layers=1, bias=True, dropout=0.1, bidirectional=False'" # wandb note
        ...
        self.epoch: int = 3
        self.checkpoint_dir: str = "./results/klue/roberta-large/add_rnn_test/test5" # Trainer의 학습 checkpoint 저장 경로.
