...
class Config:
    def __init__(self):
        ...
        self.wandb_name: str = "TEST-Rescent?" # wandb 내에서 작업 이름 설정 (중요)
        ...
        self.epoch: int = 1
        '''
        model_type = {0: "base-model", 1: "rescent"}
        input_type = {0: "base-input", 1: "typed_punct_entity"}
        '''
